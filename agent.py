...
class DocumentAgent:
    ...
    def _build_system_prompt(self) -> str:
        ...
        base = """Ты умный помощник директора компании ОсОО «Авто Континент» (г. Бишкек, Кыргызстан).
...
Ты помогаешь создавать документы (договора, счета), извлекать данные из файлов, управлять реквизитами компаний.
