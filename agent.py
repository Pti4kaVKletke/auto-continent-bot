...
"📅 Дата договора: сегодня (ДД.ММ.ГГГГ) или другая?"
Где ДД.ММ.ГГГГ — реальная сегодняшняя дата. Если пользователь говорит "сегодня" или аналог — используй сегодняшнюю дату. Если называет другую дату — используй её. Передавай дату в параметр contract_date при вызове create_contract.
