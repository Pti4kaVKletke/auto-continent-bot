...
- Серия и номер напечатаны ВЕРТИКАЛЬНО на правом поле страницы, крупными цифрами,
  читаются сверху вниз: сначала 4 цифры серии, затем 6 цифр номера (например "65 17 525507"
  → серия "6517", номер "525507"). Эта надпись повторяется дважды на развороте — на верхней
  половине и на половине с фотографией — и должна совпадать в обоих местах.
- НЕ путай это с:
  - машиночитаемой зоной (MRZ) — две строки внизу страницы с фото, с латинскими буквами
    и символами "<";
  - кодом подразделения (формат "XXX-XXX" с дефисом) — указан рядом с датой выдачи.
- Прочитай надпись на обеих половинах разворота и сравни. Если совпадает — используй.
  Если не совпадает, или ты не уверен в чтении — не угадывай, спроси пользователя.
